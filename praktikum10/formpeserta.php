	...
	<div class="row">
		...
		<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input class="<?php if(isset($jk) && $jk=="Laki-laki") echo("checked");?>" type="radio" name="jk" value="Laki-laki" <?php if($jk=='Laki-laki'){echo 'checked';}?>/> Laki-laki &nbsp &nbsp
						<input class="<?php if(isset($jk) && $jk=="Perempuan") echo("checked");?>" type="radio" name="jk" value="Perempuan" <?php if($jk=='Perempuan'){echo 'checked';}?>/> Perempuan &nbsp &nbsp
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input class="<?php echo($eror_kwn !="" ?"is-invalid" : "");?>" type="radio" name="kwn" value="Indonesia" <?php if($kwn=='Indonesia'){echo 'checked';}?>/> Indonesia (WNI) &nbsp &nbsp
						<input class="<?php echo($eror_kwn !="" ?"is-invalid" : "");?>" type="radio" name="kwn" value="Asing" <?php if($kwn!='Indonesia'&&$kwn!=''){echo 'checked';}?>/> Asing (WNA):
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input class="<?php echo($eror_pkps !="" ?"is-invalid" : "");?>" type="radio" name="pkps" value="Y" <?php if($pkps=='Y'){echo 'checked';}?>/> Ya &nbsp &nbsp
						<input class="<?php echo($eror_pkps !="" ?"is-invalid" : "");?>" type="radio" name="pkps" value="T" <?php if($pkps=='T'){echo 'checked';}?>/> Tidak &nbsp &nbsp
